...
import { Shield, BookOpen, Target, ArrowRight } from "lucide-react";
...
const ResearchCard: React.FC<ResearchCategoryProps> = ({
  ...
  return (
    <Link 
      href={`/${category}`}
      className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 block p-8"
    >
